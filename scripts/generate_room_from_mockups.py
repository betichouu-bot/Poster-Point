"""
Generate room-style mockups from any directory of mockup images.

Usage:
  python scripts/generate_room_from_mockups.py --input-dir <mockups_dir> --output-dir <room_out>

This is like `generate_room_mockups_from_mockups.py` but accepts custom paths.
"""
import os
import sys
import glob
...
def main(argv):
    ...
    if not files:
        print('No mockup files found in', args.input_dir)
        return 1

    count = 0
    for f in files:
        base = os.path.splitext(os.path.basename(f))[0]
        out_name = base + '_room.jpg'
    ...
    print('Done. Generated', count, 'room mockups in', args.output_dir)
    return 0
